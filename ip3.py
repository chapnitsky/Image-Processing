...
def q1():
    img = cv2.imread('content/MyDrive/IP/EX3/rice.jpg', 0)
    plt.title('Rice')
...
def q2():
    search_img = cv2.imread('content/MyDrive/IP/EX3/fimage_.png', 0)
...
def q3():
    four_img = cv2.imread('content/MyDrive/IP/EX3/fft1.png', 0)
    reg4 = cv2.imread('content/MyDrive/IP/EX3/4reg.png', 0)
    upside4 = cv2.imread('content/MyDrive/IP/EX3/4upside.png', 0)
...
def q4():
    img = cv2.imread('content/MyDrive/IP/EX3/fimage.png', cv2.IMREAD_GRAYSCALE)
